...
```javascript
import abbr from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-abbr@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/datasets-us-states-abbr/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/datasets-us-states-abbr/actions/workflows/test.yml?query=branch:v0.2.3
